...
<img width="2498" height="1365" alt="image" src="https://github.com/user-attachments/assets/65c899d2-e270-4820-8318-db90ce81554a" />
...
Given a car's make, model, year, mileage, transmission, fuel type, and engine size, AutoWorth AI predicts the average selling price, then compares that prediction to a seller's actual asking price and rates the deal on a 5-tier scale, from 🟢 Great Deal to 🔴 Overpriced.
...
Python, numpy, pandas, scikit-learn, TensorFlow/Keras, Streamlit, matplotlib/seaborn
...
jupyter notebook notebooks/ML-Final-Project.ipynb
